<?php
	...
	$consulta = "INSERT INTO semilleros(nombre,apellido,ficha,programa,documento,correo,telefono,fechana,inifor,periact,finaeta,instec,corrins,opcexperiencia,experiencia,opcinclinacion,inclinacion,actividades,habilidades,firmapre,firmins,ceduapre,ceduins,fechai1,fechai2,estado,estadmin) 
									VALUES('$nombre','$apellido','$ficha','$programa','$documento','$correo','$telefono','$fechana','$inifor','$periact','$finaeta','$instec','$corrins','$opcexperiencia','$experiencia','$opcinclinacion','$inclinacion','$actividades','$habilidades','$firmapre','$firmins','$ceduapre','$ceduins','$fechai1','$fechai2','$estado','$estadmin')";
