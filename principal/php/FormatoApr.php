...
<?php  
 ...
 if ($lineas!=1) {
            $consultaCam2="SELECT idT, nombreC, lineaC, estadoC, RolApreC FROM tablaparametrica WHERE lineaC=$lineas  OR  lineaC='T'"; 
             if($resultCam2 = $conexion->query($consultaCam2)){
              while($rowCam2 = mysqli_fetch_array($resultCam2)){
               ...
               $rowsRol2[$rowCam2["idT"]]=$rowCam2["RolApreC"];
...
*/           
        ...
        $consultaCam="SELECT idT, nombreC, lineaC, estadoC, RolApreC FROM tablaparametrica WHERE lineaC=$lineas  OR  lineaC='T'"; 
