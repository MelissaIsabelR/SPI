	...
	if ($conn->query($consulta) === TRUE) {
	 ...
	 $result = $conn->query($consulta2);
      ...
      if ($conn->query($consulta4) === TRUE) {
			...
			for ($k=0; $k < $_SESSION['cantidadI'] ; $k++) { 

				 $consulta5="INSERT INTO prog_proy(linea,id_proy,id_prog) VALUES ('$pro_linea','$codigo','".$_SESSION['ProgramaI"'.$k.'"']."')";
