...
if ($_SESSION['cargo']=="Aprendiz") {
 ...
 $conn = new mysqli($local,$user,$pass,$base); 
  ...
  $consultaCam="SELECT idT, nombreC, lineaC, estadoC, $Rol FROM tablaparametrica WHERE lineaC=4  OR  lineaC='T'"; 
...
<html>
<head>
  <title>Formato Modernización</title>
  <html lang="es">
    <head>
    <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
      <div class="row">
       ...
       <br><br><h5 style='text-align:center;'>Registro formato Modernización</h5><br><br>
     ...
     <?php 
      $mas="";
        ...
        <div class='row'>
        <form method="post" action="Modernizacion.php">
          <?php 
           //$_SESSION['cantidad'];
          if ($_SESSION['cantidadM']==0) {
            ...
            $cont=0;
              ...
              $C=0;
              $D=0;
                for ($pr=0; $pr < $_SESSION['cantidadM']; $pr++) {
                  $Seleccinados[$pr]=$_SESSION['ProgramaM"'.$pr.'"'];
                  $D++;
                }
                  $consulta = "SELECT * from programa ";
                  if ($resultado = $conexion->query($consulta)) { 
             ...
             <?php 
                     ...
                     $conexion = new mysqli($local,$user,$pass,$base);
                        ...
                        <div  class="input-field col s12" >
                         ...
                         <?php
                    for ($p=0; $p < $_SESSION['cantidadM']; $p++) { 
                       $consulta = "select * from programa where programaId=".$_SESSION['ProgramaM"'.$p.'"']."";
                       $result = $conexion->query($consulta);
                         echo '<div  class="input-field col s12" >';
...
?>
            ...
            <div id="Divequi_sis" class="input-field col s6" <?php echo $check; ?>>
                <input id="equi_sis" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP)</label>
            </div>
      
<?php 
if($rowsNom[166]=="descripcion1"){
if ($rowsRol[166]=="S") {
$check="style='display: block;'";
}else{
$check="style='display: none;'";
...
?>
            ...
            <div id="Divotr_com_equ" class="input-field col s6" <?php echo $check; ?>>
                <input id="otr_com_equ" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
if($rowsNom[172]=="descripcion4"){
if ($rowsRol[172]=="S") {
$check="style='display: block;'";
}else{
$check="style='display: none;'";
...
?>
            ...
            <div id="Divmaq_for_pro" class="input-field col s6" <?php echo $check; ?>>
                <input id="maq_for_pro" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
if($rowsNom[174]=="descripcion5"){
if ($rowsRol[174]=="S") {
$check="style='display: block;'";
}else{
$check="style='display: none;'";
...
?>
            ...
            <div id="Divman_maq_equi" class="input-field col s6" <?php echo $check; ?>>
                <input id="man_maq_equi" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2"> ($COP):</label>
            </div>
 
 <?php 
if($rowsNom[176]=="descripcion6"){
if ($rowsRol[176]=="S") {
$check="style='display: block;'";
}else{
$check="style='display: none;'";
...
?>
            ...
            <div id="Divotra_com_tran" class="input-field col s6" <?php echo $check; ?>>
                <input id="otra_com_tran" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
if($rowsNom[178]=="descripcion7"){
if ($rowsRol[178]=="S") {
$check="style='display: block;'";
}else{
$check="style='display: none;'";
...
?>
            ...
            <div id="Divade_cons" class="input-field col s6" <?php echo $check; ?>>
                <input id="ade_cons" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
if($rowsNom[180]=="descripcion8"){
if ($rowsRol[180]=="S") {
$check="style='display: block;'";
}else{
$check="style='display: none;'";
...
?>
             ...
             <div id="DivCvla" class="input-field col s6" <?php echo $check; ?>>
                <input id="Cvla" autocomplete="off" type="text" class="validate" data-length="200" maxlength="200">
            ...
            if (isset($_POST['apro'])) {
              ...
              if ($cantidad==0) {
                ...
                for ($i=0; $i < $cantidad ; $i++) { 
                  $_SESSION['ProgramaM"'.$i.'"']=$ArrayPro[$i];
                  $_SESSION['ProgramaM"'.$i.'"'];
                }
              ...
              <script type="text/javascript">
                swal({title: "",
                    ...
                    function(){ window.location.href="Modernizacion.php"}
                    );
              </script>
              <?php
