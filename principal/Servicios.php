...
if ($_SESSION['cargo']=="Aprendiz") {
 ...
 $conn = new mysqli($local,$user,$pass,$base); 
   ...
   $consultaCam="SELECT idT, nombreC, lineaC, estadoC, $Rol FROM tablaparametrica WHERE lineaC=3  OR  lineaC='T'"; 
...
<html>
<head>
  <title>Formato Serviciós Tecnólogicos</title>
  <html lang="es">
    <head>
    <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
      <div class="row">
       ...
       <br><br><h5 style='text-align:center;'>Registro formato Serviciós Tecnólogicos</h5>
        ...
        <form method="post" action="Servicios.php">
          ...
          if ($_SESSION['cantidadS']==0) {
            ...
            $cont=0;
              ...
              $C=0;
              $D=0;
                for ($pr=0; $pr < $_SESSION['cantidadS']; $pr++) {
                  $Seleccinados[$pr]=$_SESSION['ProgramaS"'.$pr.'"'];
                  $D++;
                }
                  $consulta = "SELECT * from programa ";
                  if ($resultado = $conexion->query($consulta)) { 
             ...
             <?php 
                     ...
                     $conexion = new mysqli($local,$user,$pass,$base);
                        ...
                        <div  class="input-field col s12" >
                         ...
                         <?php
                    for ($p=0; $p < $_SESSION['cantidadS']; $p++) { 
                       $consulta = "select * from programa where programaId=".$_SESSION['ProgramaS"'.$p.'"']."";
                       $result = $conexion->query($consulta);
                         echo '<div  class="input-field col s12" >';
...
?>
		        ...
		        <div id="Divser_per_ind" class="input-field col s6" <?php echo $check; ?>>
                <input id="ser_per_ind" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP)</label>
            </div>
 <?php 
   if($rowsNom[135]=="descripcion1"){
    if ($rowsRol[135]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divequ_sis" class="input-field col s6" <?php echo $check; ?>>
                <input id="equ_sis" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP): </label>
            </div>
<?php 
   if($rowsNom[137]=="descripcion2"){
    if ($rowsRol[137]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
           	...
           	<div id="Divsoftware" class="input-field col s6" <?php echo $check; ?>>
                <input id="software" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>
<?php 
   if($rowsNom[139]=="descripcion3"){
    if ($rowsRol[139]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divmaq_ind" class="input-field col s6" <?php echo $check; ?>>
                <input id="maq_ind" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
           	</div>

<?php 
   if($rowsNom[141]=="descripcion4"){
    if ($rowsRol[141]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divotra_com_equi" class="input-field col s6" <?php echo $check; ?>>
                <input id="otra_com_equi" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
   if($rowsNom[143]=="descripcion5"){
    if ($rowsRol[143]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divmat_for_pro" class="input-field col s6" <?php echo $check; ?>>
                <input id="mat_for_pro" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2"> ($COP):</label>
 
 <?php 
   if($rowsNom[145]=="descripcion6"){
    if ($rowsRol[145]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
			     ...
			     <div id="Divdescripcion6" class="input-field col s12" <?php echo $check; ?>>
                  <textarea id="descripcion6" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

<?php 
   if($rowsNom[146]=="man_maq_equ"){
    if ($rowsRol[146]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divman_maq_equ" class="input-field col s6" <?php echo $check; ?>>
                <input id="man_maq_equ" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
   if($rowsNom[147]=="descripcion7"){
    if ($rowsRol[147]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
			     ...
			     <div id="Divdescripcion7" class="input-field col s12" <?php echo $check; ?>>
                  <textarea id="descripcion7" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

<?php 
   if($rowsNom[148]=="ot_com_tra"){
    if ($rowsRol[148]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divot_com_tra" class="input-field col s6" <?php echo $check; ?>>
                <input id="ot_com_tra" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>
	
  <?php 
   if($rowsNom[149]=="descripcion8"){
    if ($rowsRol[149]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
                  ...
                  <textarea id="descripcion8" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

<?php 
   if($rowsNom[150]=="ot_gast_imp"){
    if ($rowsRol[150]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
			     ...
			     <div id="Divdescripcion9" class="input-field col s12" <?php echo $check; ?>>
                  <textarea id="descripcion9" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

<?php 
   if($rowsNom[152]=="div_act"){
    if ($rowsRol[152]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
                ...
                <input id="div_act" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>

<?php 
   if($rowsNom[153]=="descripcion10"){
    if ($rowsRol[153]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
			     ...
			     <div id="Divdescripcion10" class="input-field col s12" <?php echo $check; ?>>
                  <textarea id="descripcion10" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

<?php 
   if($rowsNom[154]=="via_gast_int"){
    if ($rowsRol[154]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
                  ...
                  <textarea id="descripcion11" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

<?php 
   if($rowsNom[156]=="ade_cont"){
    if ($rowsRol[156]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
            ...
            <div id="Divade_cont" class="input-field col s6" <?php echo $check; ?>>
                <input id="ade_cont" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>
<?php 
   if($rowsNom[157]=="descripcion12"){
    if ($rowsRol[157]=="S") {
      $check="style='display: block;'";
    }else{
      $check="style='display: none;'";
...
?>
                  ...
                  <textarea id="descripcion12" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>
<?php 
            ...
            if (isset($_POST['apro'])) {
              ...
              if ($cantidad==0) {
                ...
                for ($i=0; $i < $cantidad ; $i++) { 
                  $_SESSION['ProgramaS"'.$i.'"']=$ArrayPro[$i];
                  $_SESSION['ProgramaS"'.$i.'"'];
                }
              ...
              <script type="text/javascript">
                swal({title: "",
                    ...
                    function(){ window.location.href="Servicios.php"}
                    );
              </script>
              <?php
