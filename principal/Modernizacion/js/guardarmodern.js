function crear(cant, estado){
  ...
  for (var i = 1; i <= cant; i++) {
	...
	return;
			...
			$.ajax({
				  url: "Modernizacion/insertar.php",
				  data: {
	...
	Divequi_sis = document.getElementById("Divequi_sis").style;
	...
	Divotr_com_equ = document.getElementById("Divotr_com_equ").style;
	Divdescripcion4 = document.getElementById("Divdescripcion4").style;
	Divmaq_for_pro = document.getElementById("Divmaq_for_pro").style;
	Divdescripcion5 = document.getElementById("Divdescripcion5").style;
	Divman_maq_equi = document.getElementById("Divman_maq_equi").style;
	Divdescripcion6 = document.getElementById("Divdescripcion6").style;
	Divotra_com_tran = document.getElementById("Divotra_com_tran").style;
	...
	return;		
	}else if(Divequi_sis.display=="block" && document.getElementById("equi_sis").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("equi_sis").focus();
	return;	
	...
	return;
	}else if(Divotr_com_equ.display=="block" && document.getElementById("otr_com_equ").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("otr_com_equ").focus();
	return;
	...
	return;
	}else if(Divmaq_for_pro.display=="block" && document.getElementById("maq_for_pro").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("maq_for_pro").focus();
	return;
	...
	return;
	}else if(Divman_maq_equi.display=="block" && document.getElementById("man_maq_equi").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("man_maq_equi").focus();
	return;
	...
	return;
	}else if(Divotra_com_tran.display=="block" && document.getElementById("otra_com_tran").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("otra_com_tran").focus();
	return;
...
function EditarProymodernizacion(estado){
   ...
   if (cant!="0") {
	...
	return;
   		...
   		document.getElementById('res').innerHTML = '<div class="preloader-wrapper active"><div class="spinner-layer spinner-blue-only"><div class="circle-clipper left"><div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div>';
			...
			$.ajax({
				  url: "Modernizacion/actualizar.php",
				  data: {
				        identificacion : $("#identificacion").val(),
				        //anexo : $("#anexo").val(),
				        Cantidad : cant,                                             
