function crear(cant, estado){
  ...
  for (var i = 1; i <= cant; i++) {
	...
	return;
			...
			$.ajax({
				  url: "investigacion/insertar.php",
				  data: {
...
*/				   	/*$("#res").html(response);*/
	...
	Divnum_pers_int_cm = document.getElementById("Divnum_pers_int_cm").style;
	...
	Divot_se_pe_in = document.getElementById("Divot_se_pe_in").style;
	Divdescripcion1 = document.getElementById("Divdescripcion1").style;
	Divse_pe_in = document.getElementById("Divse_pe_in").style;
	Divdescripcion2 = document.getElementById("Divdescripcion2").style;
	Diveq_de_si = document.getElementById("Diveq_de_si").style;
	Divdescripcion3 = document.getElementById("Divdescripcion3").style;
	Divsofware = document.getElementById("Divsofware").style;
	...
	Divotr_com_equi = document.getElementById("Divotr_com_equi").style;
	Divdescripcion6 = document.getElementById("Divdescripcion6").style;
	Divma_pa_for = document.getElementById("Divma_pa_for").style;
	...
	Divgast_bien = document.getElementById("Divgast_bien").style;
	Divdescripcion13 = document.getElementById("Divdescripcion13").style;
	Divade_cons = document.getElementById("Divade_cons").style;
	Divdescripcion14 = document.getElementById("Divdescripcion14").style;
	Divmonitores = document.getElementById("Divmonitores").style;
	Divdescripcion15 = document.getElementById("Divdescripcion15").style;
	...
	return;
	}else if(Divnum_pers_int_cm.display=="block" && document.getElementById("num_pers_int_cm").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;		
	}else if(Divot_se_pe_in.display=="block" && document.getElementById("ot_se_pe_in").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;	
    }else if(Divse_pe_in.display=="block" && document.getElementById("se_pe_in").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;
	}else if(Diveq_de_si.display=="block" && document.getElementById("eq_de_si").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;
	}else if(Divsofware.display=="block" && document.getElementById("sofware").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;
	}else if(Divotr_com_equi.display=="block" && document.getElementById("otr_com_equi").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;
	}else if(Divma_pa_for.display=="block" && document.getElementById("ma_pa_for").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	...
	return;
	}else if(Divgast_bien.display=="block" && document.getElementById("gast_bien").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("gast_bien").focus();
	return;	
	}else if(Divdescripcion13.display=="block" && document.getElementById("descripcion13").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("descripcion13").focus();
	return;
	}else if(Divade_cons.display=="block" && document.getElementById("ade_cons").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("ade_cons").focus();
	return;
	}else if(Divdescripcion14.display=="block" && document.getElementById("descripcion14").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("descripcion14").focus();
	return;
	}else if(Divmonitores.display=="block" && document.getElementById("monitores").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
	document.getElementById("monitores").focus();
	return;
	}else if(Divdescripcion15.display=="block" && document.getElementById("descripcion15").value==""){
	document.getElementById('res').innerHTML = 'Rellene este Campo';
...
function EditarProyinvestigacion(estado){
   ...
   if (cant!="0") {
	...
	return;
   		...
   		document.getElementById('res').innerHTML = '<div class="preloader-wrapper active"><div class="spinner-layer spinner-blue-only"><div class="circle-clipper left"><div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div>';
			...
			$.ajax({
				  url: "investigacion/actualizar.php",
				  data: {
				        identificacion : $("#identificacion").val(),
				        //anexo : $("#anexo").val(),
				        Cantidad : cant,                                             
