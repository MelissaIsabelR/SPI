...
<head>
  ...
  <html lang="es">
   ...
   <!-- <script src="js/Formularioscrea.js"></script>-->
    ...
    <script type="text/javascript" src="Servicios/js/guardarServic.js"></script>
    <script type="text/javascript" src="Modernizacion/js/guardarmodern.js"></script>
...
<script type="text/javascript">
  function crearProdEdit(cantidad,Inicio){
   
     $.ajax({
     url: "php/ajax.php",
           data: {
                  'accion' : 'productEditar',
                  cantidad : cantidad,
                  Inicio : Inicio
   ...
   if($result = $conexion->query($consultaP)){
    $lista='
      ...
      if ($_SESSION['cargo']=="Aprendiz") {
        ...
        if ($line!=1) {
             $consultaCam2="SELECT idT, nombreC, lineaC, estadoC, $Rol FROM tablaparametrica WHERE lineaC=$line  OR  lineaC='T'"; 
        ...
        $consultaCam="SELECT idT, nombreC, lineaC, estadoC, $Rol FROM tablaparametrica WHERE lineaC=$line  OR  lineaC='T'"; 
...
<label class="active" id="sesione">Información de Centro Proponente:</label>
         ...
         <input id="codigoPro" type="hidden" value='.$_GET['c'].'>
           ...
           <div style="display: none;" class="input-field col s6">
              <input id="identificacion" type="text" class="validate" autocomplete="off" value="'.$_SESSION["user_id"].'">
            ...
            if($rowsNom[3]=="pro_region"){
              ...
              while($rowRegi = mysqli_fetch_array($resultRegi)){ 
                ...
                $formulario.='<OPTION selected VALUE="'.$rowRegi['id_region'].'">'.$rowRegi['nombre_region'].'</OPTION>'; 

                }else{
                 $formulario.='<OPTION VALUE="'.$rowRegi['id_region'].'">'.$rowRegi['nombre_region'].'</OPTION>'; 
                }
            }
              $formulario.='</select>
              <label id="caja2">Regional</label>
              </div>';
              ...
              while($rowCent = mysqli_fetch_array($resultCent)){ 
                 ...
                 if ($row2["codigo"]==$rowCent['codigo']) {
                    ...
                    $formulario.='<OPTION VALUE="'.$rowCent['codigo'].'" selected>'.$rowCent['nombre_centro'].'</OPTION>'; 

                }else{

                  $formulario.='<OPTION VALUE="'.$rowCent['codigo'].'">'.$rowCent['nombre_centro'].'</OPTION>'; 
 
                } 
              }
              $formulario.='</select>
              <label id="caja2">Seleccione el centro</label>
              </div>';
        ...
        $formulario.='
             ...
             <div id="Divnom_sub" class="input-field col s6" '.$check.'>
                <input  id="nom_sub" type="text" class="validate" autocomplete="off" data-length="30" maxlength="30" value="'.$nombreSub.'">
        ...
        $formulario.='<div id="Divema_sub" class="input-field col s6" '.$check.'>
                <input  id="ema_sub" type="text" class="validate" autocomplete="off" data-length="30" maxlength="30" value="'.$emailSub.'">
        ...
        $formulario.='<div id="Divnum_cel_sub" class="input-field col s6" '.$check.'>
                <input  id="num_cel_sub" type="text" class="validate" autocomplete="off" data-length="15" maxlength="15" value="'.$NumCelSub.'">
        ...
        $formulario.='
             <div id="Divpro_autores" class="input-field col s6" '.$check.'>
                <input  id="pro_autores" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["pro_autores"].'">
        ...
        $formulario.='
             ...
             <div id="Divnom_rad_pro" class="input-field col s6"  '.$check.'>
                <input  id="nom_rad_pro" type="text" class="validate" autocomplete="off" data-length="30" maxlength="30"  value="'.$row2["nom_rad_pro"].'">
        ...
        $formulario.='
            ...
            <div id="Divnum_identi"  class="input-field col s6" '.$check.'>
                <input  id="num_identi" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100"  value="'.$row2["num_identi"].'">
        ...
        $formulario.=' 
            ...
            <div id="Divema_rad_pro" class="input-field col s6" '.$check.'>
                <input  id="ema_rad_pro" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100"  value="'.$row2["ema_rad_pro"].'">
        ...
        $formulario.=' 
            ...
            <div id="DivCel_rad_pro" class="input-field col s6" '.$check.'>
                <input  id="Cel_rad_pro" type="text" class="validate" autocomplete="off" data-length="50" maxlength="50"  value="'.$row2["Cel_rad_pro"].'">
...
<label class="active" id="sesione" >Información del Proyecto</label>
        ...
        $formulario.=' 
           ...
           <div id="Divtitulo_pro" class="input-field col s12" '.$check.'>
                <input  id="titulo_pro"  type="text" class="validate" autocomplete="off" data-length="50" maxlength="50" value="'.$row2["titulo_pro"].'">
     ...
     '; 
        ...
        $formulario.=' 
           ...
           <div id="Divarea_con_1" class="input-field col s6" '.$check.'>
              <input  id="area_con_1"  type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["area_con_1"].'">
        ...
        $formulario.=' 
            ...
            <div id="Divarea_con_2" class="input-field col s6">
              <input  id="area_con_2"  type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["area_con_2"].'">
             ...
             $formulario.='<div id="Divapli_posconf" class="input-field col s6" '.$check.'>
              ...
              while($rowPostC = mysqli_fetch_array($resultPostC)){ 
                 ...
                 if ($row2["apli_posconf"]==$rowPostC['apli_posconf']) {
                    ...
                    $formulario.='<OPTION VALUE="'.$rowPostC['apli_posconf'].'" selected>'.$rowPostC['apli_posconf'].'</OPTION>'; 

                }
                  if ($row2["apli_posconf"]=="Si") {
                    $formulario.='<OPTION VALUE="No">No</OPTION>'; 
                  }else{
                     $formulario.='<OPTION VALUE="Si">Si</OPTION>'; 
                  }

              
            }
              $formulario.='</select>
              <label id="caja2">Aplica al posconflicto</label>
              </div>';
            ...
            $formulario.='<div id="Divmuni_impact" class="input-field col s6" '.$check.'>
                  <textarea  id="muni_impact"  class="materialize-textarea" data-length="100" maxlength="100">'.$row2["muni_impact"].'</textarea>
            ...
            <div id="Divdes_estra" class="input-field col s6" '.$check.'>
                  <textarea  id="des_estra"  class="materialize-textarea" data-length="100" maxlength="100">'.$row2["des_estra"].'</textarea>
            ...
            <div id="Divrecu_poscof" class="input-field col s6" '.$check.'>
                <input  id="recu_poscof"  type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["recu_poscof"].'">
            ...
            <div id="Divante_just_pro" class="input-field col s12" '.$check.'>
                  <textarea  id="ante_just_pro"  class="materialize-textarea" >'.$row2["ante_just_pro"].'</textarea>
            ...
            <div id="Divplan_pro_nec" class="input-field col s12" '.$check.'>
                  <textarea  id="plan_pro_nec"  class="materialize-textarea" >'.$row2["plan_pro_nec"].'</textarea>
            ...
            <div id="Divfech_ini_pro" class="input-field col s6" '.$check.'>
                <input  id="fech_ini_pro"  type="date" class="validate" autocomplete="off" value='.$row2["fech_ini_pro"].'>
            ...
            <div id="Divfech_fin_pro" class="input-field col s6" '.$check.'>
                <input  id="fech_fin_pro" type="date" class="validate" autocomplete="off" value='.$row2["fech_fin_pro"].'>
            ...
            $formulario.='<div id="Divnom_gru_inv" class="input-field col s12" '.$check.'>
            ...
            while($rowGrupo = mysqli_fetch_array($resultGrupo)){ 
              if ($row2["id"]==$rowGrupo['id']) {
                $formulario.='<OPTION VALUE="'.$rowGrupo['id'].'"selected>'.$rowGrupo['nombre_grupo'].'</OPTION>'; 
              }else{
                $formulario.='<OPTION VALUE="'.$rowGrupo['id'].'">'.$rowGrupo['nombre_grupo'].'</OPTION>'; 

              }
            }
            $formulario.='</select>
            <label id="caja2">Nombre de grupo de Investigacion</label>
            </div>';
             ...
             $formulario.='<div id="Divcod_grupo" class="input-field col s6" '.$check.'>
                <input   id="cod_grupo"  type="text" class="validate" autocomplete="off" data-length="30" maxlength="30" value="'.$row2["cod_grupo"].'">
             ...
             <div id="Divnum_sem_bene" class="input-field col s6" '.$check.'>
                <input   id="num_sem_bene"  type="number" class="validate" autocomplete="off" data-length="4" maxlength="4" value="'.$row2["num_sem_bene"].'">
             ...
             <div id="Divnomb_sem_bene" class="input-field col s12" '.$check.'>
                  <textarea   id="nomb_sem_bene"  class="materialize-textarea" data-length="100" maxlength="100">'.$row2["nomb_sem_bene"].'</textarea>
             ...
             <div id="Divdes_meto_pro"  class="input-field col s12" '.$check.'>
                <textarea   id="des_meto_pro"  class="materialize-textarea">'.$row2["des_meto_pro"].'</textarea>
            ...
            <div id="Divnum_pro_bene" class="input-field col s6" '.$check.'>
                <input   id="num_pro_bene"  type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["num_pro_bene"].'">
           ...
           <div id="Divnom_pro_bene" class="input-field col s6" '.$check.'>
                <input   id="nom_pro_bene"  type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["nom_pro_bene"].'">
            ...
            <div id="Divimp_esperado" class="input-field col s12" '.$check.'>
                  <textarea   id="imp_esperado"  class="materialize-textarea">'.$row2["imp_esperado"].'</textarea>
      ...
      <!--<label  style="color:black; float:left;"><b><u>Recursos Humanos:</u></b></label>-->
         ...
         ';
            ...
            <div id="Divnum_per_ext" class="input-field col s4" '.$check.'>
                <input  id="num_per_ext"  type="number" class="validate" autocomplete="off" data-length="3" maxlength="3"  value="'.$row2["num_per_ext"].'">
             ...
             <div id="Divnom_apr_ext" class="input-field col s8" '.$check.'>
                <input  id="nom_apr_ext" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100"  value="'.$row2["nom_apr_ext"].'">
             ...
             <div id="Divnum_iden_ext"  class="input-field col s12" '.$check.'>
                <input  id="num_iden_ext" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100"  value="'.$row2["num_iden_ext"].'">
                <label  id="caja2" class="active" for="first_name2">Numeros de identificacion</label>
            </div>
...
<div class="input-field col s12" '.$check.'>
  <label class="active" id="sesione">Número de personal interno(Aprendices Sin Contrato de apredizaje)</label>
            ...
            <div id="Divnum_pers_int_s" class="input-field col s4" '.$check.'>
                <input  id="num_pers_int_s" type="number" class="validate" autocomplete="off" data-length="3" maxlength="3" value="'.$row2["num_pers_int_s"].'">
           ...
           <div id="Divnom_ape_int_s" class="input-field col s8" '.$check.'>
                <input  id="nom_ape_int_s" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["nom_ape_int_s"].'">
                <label  id="caja2" class="active" for="first_name2">Nombres y apellidos:</label>
            </div>
           ...
           <div id="Divnum_iden_int_s" class="input-field col s12" '.$check.'>
                <input   id="num_iden_int_s"  type="text" class="validate" autocomplete="off" data-length="100" maxlength="100"  value="'.$row2["num_iden_int_s"].'">
                <label  id="caja2" class="active" for="first_name2">Numeros de Identificacion:</label>
            </div>
...
<label class="active" id="sesione">Número de personal interno(Aprendices con Contrato de apredizaje)</label>
            ...
            <div id="Divnum_pers_int_c" class="input-field col s12" '.$check.'>
                <input   id="num_pers_int_c"  type="number" class="validate" autocomplete="off" data-length="3" maxlength="3" value="'.$row2["num_pers_int_c"].'">
                <label  id="caja2" class="active" for="first_name2">Número de personal interno</label>
            </div>';
...
<label class="active" id="sesione">Número de personal interno (Aprendices Con Contrato de monitoria)</label>
          ...
          ';
            ...
            <div id="Divnum_pers_int_cm" class="input-field col s12" '.$check.'>
                <input  id="num_pers_int_cm"  type="number" class="validate" autocomplete="off" data-length="3" maxlength="3" value="'.$row2["num_pers_int_cm"].'">
                <label  id="caja2" class="active" for="first_name2">Número de personal interno </label>
            </div>';
}
...
<label class="active" id="sesione">(Número de personal interno (Instructores)</label>
            ...
            <div id="Divnum_pers_int_in" class="input-field col s12" '.$check.'>
                <input  id="num_pers_int_in" type="number" class="validate" autocomplete="off" data-length="3" maxlength="3" value="'.$row2["num_pers_int_in"].'">
                <label  id="caja2" class="active" for="first_name2">Número de personal interno </label>
            </div>
            ...
            <div id="Divnom_apellidos" class="input-field col s12" '.$check.'>
                  <textarea  id="nom_apellidos" class="materialize-textarea" data-length="100" maxlength="100">'.$row2["nom_apellidos"].'</textarea>
            ...
            <div id="Divnum_idenficac" class="input-field col s12" '.$check.'>
                <input  id="num_idenficac" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["num_idenficac"].'">
...
<label class="active" id="sesione">Número de personal interno (Otros-TP-TA-SENNOVA)</label>
            ...
            <div id="Divnum_per_int_s" class="input-field col s12" '.$check.'>
                <input  id="num_per_int_s" type="number" class="validate" autocomplete="off" data-length="3" maxlength="3" value="'.$row2["num_per_int_s"].'">
                <label  id="caja2" class="active" for="first_name2">Número de personal interno:</label>
            </div>
          ...
          ';
            ...
            <div id="Divnom_apell_pers" class="input-field col s12" '.$check.'>
                  <textarea  id="nom_apell_pers" class="materialize-textarea" type="text" data-length="100" maxlength="100">'.$row2["nom_apell_pers"].'</textarea>
                <label  id="caja2" class="active" for="first_name2">nombres y apellidos</label>
            </div>
            ...
            <div id="Divnum_iden_pers" class="input-field col s12" '.$check.'>
                <input  id="num_iden_pers" type="text" class="validate" autocomplete="off" data-length="100" maxlength="100" value="'.$row2["num_iden_pers"].'">
                <label  id="caja2" class="active" for="first_name2">numeros de identificacion</label>
            </div>
...
<label class="active" id="sesione">Aliados Externos y/o Contrapartida</label>
           ...
           ';
            ...
            <div id="Divnom_ali_int" class="input-field col s12" '.$check.'>
                <input  id="nom_ali_int" type="text" class="validate" autocomplete="off" data-length="30" maxlength="30"   value="'.$row2["nom_ali_int"].'">
            ...
            <div id="Divnit" class="input-field col s6" '.$check.'>
                <input  id="nit" class="validate" autocomplete="off" data-length="8" maxlength="8"  value="'.$row2["nit"].'">
            ...
            ';
             ...
             <div id="Divrec_esp_ent_ext" class="input-field col s6" '.$check.'>
                <input  id="rec_esp_ent_ext" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"  value="'.$row2["rec_esp_ent_ext"].'">
          ...
          ';
           ...
           <div id="Divrec_din_ent_ext" class="input-field col s6" '.$check.'>
                <input  id="rec_din_ent_ext" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["rec_din_ent_ext"].'">
             ...
             <div id="Divrec_esp_ent_int" class="input-field col s6" '.$check.'>
                <input  id="rec_esp_ent_int" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["rec_esp_ent_int"].'">
             ...
             <div id="Divrec_din_ent_int" class="input-field col s6" '.$check.'>
                <input  id="rec_din_ent_int" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["rec_din_ent_int"].'">
             ...
             <div id="Divcui_mun_inf" class="input-field col s6" '.$check.'>
                  <textarea  id="cui_mun_inf" class="materialize-textarea">'.$row2["cui_mun_inf"].'</textarea>
            ...
            ';
             ...
             <div id="Divdes_ali_obj" class="input-field col s12" '.$check.'>
                  <textarea  id="des_ali_obj" class="materialize-textarea">'.$row2["des_ali_obj"].'</textarea>
             ...
             $formulario.='
              ...
              <label class="active" id="sesione">OTROS SERVICIOS PERSONALES INDIRECTOS (Aprendices)</label>
                          ...
                          <div id="Divot_se_pe_in" class="input-field col s6" '.$check.'> 
                              <input  id="ot_se_pe_in" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"value="'.$row2["ot_se_pe_in"].'"
                         ...
                         $formulario.='
                          ...
                          <div id="Divdescripcion1" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion1" class="materialize-textarea">'.$row2["descripcion1"].'</textarea>
              ...
              <label class="active" id="sesione">SERVICIOS PERSONALES INDIRECTOS</label>
                         ...
                         $formulario.='
                          ...
                          <div id="Divse_pe_in" class="input-field col s6" '.$check.'>
                              <input  id="se_pe_in" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"value="'.$row2["se_pe_in"].'"
                              <label id="caja2" class="active" for="first_name2">($COP): </label>
                          </div>
                         ...
                         $formulario.='
                          ...
                          <div id="Divdescripcion2" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion2" class="materialize-textarea">'.$row2["descripcion2"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione"> EQUIPO DE SISTEMAS</label>
                         ...
                         $formulario.='
                          <div id="Diveq_de_si" class="input-field col s6" '.$check.'>
                              <input  id="eq_de_si" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"value="'.$row2["eq_de_si"].'"
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                        ...
                        ';
                         ...
                         <div id="Divdescripcion3" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion3" class="materialize-textarea">'.$row2["descripcion3"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
                        ...
                        ';
                         ...
                         $formulario.='
                          ...
                          <div id="Divsofware" class="input-field col s6" '.$check.'>
                              <input  id="sofware" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["sofware"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         $formulario.='
                          ...
                          <div id="Divdescripcion4" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion4" class="materialize-textarea">'.$row2["descripcion4"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">MAQUINARIA INDUSTRIAL</label>
                         ...
                         $formulario.=' 
                          ...
                          <div id="Divmaq_ind" class="input-field col s6" '.$check.'>
                              <input  id="maq_ind" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["maq_ind"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         <div  id="Divdescripcion5" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion5" class="materialize-textarea">'.$row2["descripcion5"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
                     ';
              ...
              <label class="active" id="sesione">OTRAS COMPRAS DE EQUIPOS</label>
                         ...
                         $formulario.=' 
                          ...
                          <div  id="Divotr_com_equi" class="input-field col s6" '.$check.'>
                              <input  id="otr_com_equi" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["otr_com_equi"].'">
                              <label id="caja2" class="active" for="first_name2"> ($COP):</label>
                          </div>
                       ...
                       ';
                         ...
                         <div  id="Divdescripcion6" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion6" class="materialize-textarea">'.$row2["descripcion6"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
                         ';
              ...
              <label class="active" id="sesione">MATERIALES PARA FORMACION PROFESIONAL<label>
                         ...
                         $formulario.='
                          <div  id="Divma_pa_for" class="input-field col s6" '.$check.'>
                              <input  id="ma_pa_for" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["ma_pa_for"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>  
                             ';
                         ...
                         <div  id="Divdescripcion7" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion7" class="materialize-textarea">'.$row2["descripcion7"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">MANTENIMIENTO DE MAQUINARIA, EQUIPO, TRANSPORTE Y SOFWARE</label>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divman_maq_equ" class="input-field col s6" '.$check.'>
                              <input  id="man_maq_equ" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["man_maq_equ"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divdescripcion8" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion8" class="materialize-textarea">'.$row2["descripcion8"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">OTROS COMUNICACIONES Y TRANSPORTE<label>
                         ...
                         $formulario.='
                          ...
                          <div id="Divot_com_tra"  class="input-field col s6" '.$check.'>
                              <input  id="ot_com_tra" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["ot_com_tra"].'">
                              <label id="caja2" class="active" for="first_name2"> ($COP):</label>
                          </div>
                         ...
                         <div  id="Divdescripcion9" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion9" class="materialize-textarea">'.$row2["descripcion9"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label  class="active" id="sesione">OTROS GASTOS POR IMPRESOS Y PUBLICACIONES</label>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divot_gast_imp" class="input-field col s6" '.$check.'>
                              <input  id="ot_gast_imp" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["ot_gast_imp"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         <div  id="Divdescripcion10" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion10" class="materialize-textarea">'.$row2["descripcion10"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">DIVULGACION DE ACTIVIDADES DE GESTION INSTITUCIONA</label>
                         ...
                         $formulario.='
                           ...
                           <div  id="Divdiv_act" class="input-field col s6" '.$check.'>
                              <input  id="div_act" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["div_act"].'">
                              <label id="caja2" class="active" for="first_name2">($COP): </label>
                            </div>
                         ...
                         $formulario.='
                           ...
                           <div  id="Divdescripcion11" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion11" class="materialize-textarea">'.$row2["descripcion11"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">VIATICOS Y GASTOS DE VIAJE AL INTERIOR FORMACION PROFESIONAL</label>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divvia_gast_int" class="input-field col s6" '.$check.'>
                              <input  id="via_gast_int" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["via_gast_int"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divdescripcion12" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion12" class="materialize-textarea">'.$row2["descripcion12"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label  class="active" id="sesione">GASTOS BIENESTAR ALUMNOS</label>
                        ...
                        ';
                         ...
                         $formulario.='
                          ...
                          <div id="Divgast_bien"  class="input-field col s6" '.$check.'>
                              <input  id="gast_bien" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["gast_bien"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                        ...
                        ';
                         ...
                         <div  id="Divdescripcion13" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion13" class="materialize-textarea">'.$row2["descripcion13"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">ADECUACIONES Y CONSTRUCCIONES</label>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divade_cons" class="input-field col s6" '.$check.'>
                              <input  id="ade_cons" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["ade_cons"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divdescripcion14" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion14" class="materialize-textarea">'.$row2["descripcion14"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
              ...
              <label class="active" id="sesione">MONITORES</label>
                        ...
                        ';
                         ...
                         $formulario.='
                          ...
                          <div  id="Divmonitores"  class="input-field col s6" '.$check.'>
                              <input  id="monitores" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["monitores"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divdescripcion15" class="input-field col s12" '.$check.'>
                                <textarea  id="descripcion15" class="materialize-textarea">'.$row2["descripcion15"].'</textarea>
                                <label id="caja2" for="textarea1">descripcion</label>
                          </div>
                          ';
                ...
                <div id="DivCvla" class="input-field col s12" '.$check.'>
                      <textarea   id="Cvla"  class="materialize-textarea">'.$row2["LinkCvlac"].'</textarea>
             ...
             $formulario.='
              ...
              <label class="active" id="sesione">OTROS SERVICIOS PERSONALES INDIRECTOS (Aprendices)</label>
                          ...
                          <div id="Divser_per_ind" class="input-field col s6">
                              <input  id="ser_per_ind" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"value="'.$row2["ser_per_ind"].'"
                              <label id="caja2" class="active" for="first_name2">($COP)</label>
                          </div>
              ...
              <label class="active" id="sesione">SERVICIOS PERSONALES INDIRECTOS</label>
                         ...
                         $formulario.='
                          ...
                          <div id="Divequ_sis" class="input-field col s6" '.$check.'>
                              <input  id="equ_sis" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"value="'.$row2["equ_sis"].'"
                              <label id="caja2" class="active" for="first_name2">($COP): </label>
                          </div>
              ...
              <label class="active" id="sesione"> EQUIPO DE SISTEMAS</label>
                         ...
                         $formulario.='
                          <div id="Divsoftware" class="input-field col s6" '.$check.'>
                              <input  id="software" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8"value="'.$row2["software"].'"
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
              ...
              <label class="active" id="sesione">MAQUINARIA INDUSTRIAL</label>
                         ...
                         $formulario.=' 
                          ...
                          <div id="Divotra_com_equi" class="input-field col s6" '.$check.'>
                              <input  id="otra_com_equi" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["otra_com_equi"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
              ...
              <label class="active" id="sesione">OTRAS COMPRAS DE EQUIPOS</label>
                         ...
                         $formulario.=' 
                          ...
                          <div  id="Divmat_for_pro" class="input-field col s6" '.$check.'>
                              <input  id="mat_for_pro" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["mat_for_pro"].'">
                              <label id="caja2" class="active" for="first_name2"> ($COP):</label>
                          </div>
              ...
              <label class="active" id="sesione">VIATICOS Y GASTOS DE VIAJE AL INTERIOR FORMACION PROFESIONAL</label>
                         ...
                         $formulario.='
                          ...
                          <div  id="Divade_cont" class="input-field col s6" '.$check.'>
                              <input  id="ade_cont" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["ade_cont"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
             ...
             $formulario.='
              ...
              <label class="active" id="sesione">EQUIPO DE SISTEMAS</label>
                          ...
                          <div id="Divequi_sis" class="input-field col s12" '.$check.'>
                                <textarea  id="equi_sis" class="materialize-textarea">'.$row2["equi_sis"].'</textarea>
                        ...
                        ';
                         ...
                         $formulario.='
                          ...
                          <div id="Divotr_com_equ" class="input-field col s6" '.$check.'>
                              <input  id="otr_com_equ" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["otr_com_equ"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                ...
                <label class="active" id="sesione">MATERIALES PARA FORMACION PROFESIONAL</label>
                         ...
                         $formulario.=' 
                          ...
                          <div id="Divmaq_for_pro" class="input-field col s6" '.$check.'>
                              <input  id="maq_for_pro" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["maq_for_pro"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>
                ...
                <label class="active" id="sesione">ANTENIMIENTO DE MAQUINARIA, EQUIPO, TRANSPORTE Y SOFTWARE</label>
                         ...
                         $formulario.=' 
                          ...
                          <div  id="Divman_maq_equi" class="input-field col s6" '.$check.'>
                              <input  id="man_maq_equi" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["man_maq_equi"].'">
                              <label id="caja2" class="active" for="first_name2"> ($COP):</label>
                          </div>
                ...
                <label class="active" id="sesione">OTRAS COMUNICACIONES Y TRANPORTE<label>
                         ...
                         $formulario.='
                          <div  id="Divotra_com_tran" class="input-field col s6" '.$check.'>
                              <input  id="otra_com_tran" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["otra_com_tran"].'">
                              <label id="caja2" class="active" for="first_name2">($COP):</label>
                          </div>  
                             ';
...
$formulario.='
            ...
            <div id="Divdi_ac_ge_in" class="input-field col s6" '.$check.'>
                ...
                <input    id="di_ac_ge_in" type="number" class="validate" autocomplete="off" data-length="8" maxlength="8" value="'.$row2["di_ac_ge_in"].'">
                <label id="caja2"class="active" for="first_name2">($COP):</label>
            </div>
...
?>
 <!--//////////////////////////////////ESPACIO DE LOS OBJETIVOS GENERALES Y PRODUCTOS////////////////-->
  ...
  //$ContOpr=0;
       ...
       $result3 = $conexion->query($consulta2);

          if($row213 = mysqli_fetch_array($result3)){
          $formulario.='<div class="input-field col s12">
                        <textarea id="ObjeGene" class="materialize-textarea">'.$row213['general'].'</textarea>
                        <label for="textarea1" id="caja2">Objetivo General</label>
                  </div>';
          }
      ...
      if($result2 = $conexion->query($consulta2)){
       ...
       <td>
         <div class="input-field col s12">
         <input type="hidden" id="ids'.$i.'" value='.$row21["id"].'>
          <textarea   id="obj_esp'.$i.'"  class="materialize-textarea">'.$row21["objetivo"].'</textarea>
        ...
        <td>
        <div class="input-field col s12">
        <textarea   id="result'.$i.'"  class="materialize-textarea">'.$row21["resultado"].'</textarea>
        ...
        <td>
        <div class="input-field col s12">
        <textarea   id="produt'.$i.'"  class="materialize-textarea">'.$row21["producto"].'</textarea>
        ...
        $CantOb=$i-1;
               $formulario.="<input type='hidden' id='CantObj2' value='".$CantOb."'>";




        $formulario.="</tbody></table>";
        $formulario.='<div class="input-field col s12" ID="resultObje">
         <input type="hidden" id="CantObj" value="0">
         ...
         if ($estadoReg!="2") {
         $formulario.=' <div class="input-field col s12">
             <h6>Agregar mas Objetivos</h6>
             
              <button class="btn waves-effect waves-light Orange text-darken-2" onclick="crearProdEdit(1,'.$i.' )">1</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(2,'.$i.')">2</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(3,'.$i.')">3</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(4,'.$i.')">4</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(5,'.$i.')">5</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(6,'.$i.')">6</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(7,'.$i.')">7</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(8,'.$i.')">8</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(9,'.$i.')">9</button>
              <button class="btn waves-effect waves-light Orange text-darken-1" onclick="crearProdEdit(10,'.$i.' )">10</button>
            <br><br>
          </div>

           <div class="input-field col s12" id="res" style="color: red;"> 
      ...
      if ($estadoReg!="2") {
          $formulario.="<div id='EnPr' ><center> <button id='Guardado' onclick='EditarProy".$_GET['t']."(1)' class='btn waves-effect waves-light green text-darken-2'>Guardar</button> <button id='agregar' style='margin-left:10px;' onclick='EditarProy".$_GET['t']."(2)' class='btn waves-effect waves-light green text-darken-2'>Enviar</button></center></div><br><br>";
        // echo $formulario; 
      }
