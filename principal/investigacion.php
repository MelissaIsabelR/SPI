...
if ($_SESSION['cargo']=="Aprendiz") {
 ...
 $consultaCam="SELECT idT, nombreC, lineaC, estadoC, $Rol FROM tablaparametrica WHERE lineaC=1  OR  lineaC='T'"; 
...
<html>
<head>
  <title>Formato Investigación</title>
  <html lang="es">
    <head>
    <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
      ...
      <br><br><h5 style='text-align:center;'>Registro formato Investigación</h5>
    ...
    <!-- <form id="archivo" action="<?php //echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
          <SPAN>Adjunte aqui los anexos del proyecto en un archivo(.rar)</SPAN>
           ...
           <span style="color:white;">Archivo</span>  
     ...
     <?php 
      $mas="";
        ...
        <span>Añadir <?php echo $mas; ?> Porgramas </span>

        </div>
        <div class='collapsible-body'><span></span>

        <div class='row'>
        <form method="post" action="investigacion.php">
          <?php 
           //$_SESSION['cantidad'];
          if ($_SESSION['cantidad']==0) {
            ...
            $cont=0;
              ...
              $C=0;
              $D=0;
                for ($pr=0; $pr < $_SESSION['cantidad']; $pr++) {
                  $Seleccinados[$pr]=$_SESSION['Programa"'.$pr.'"'];
                  $D++;
                }
                  $consulta = "SELECT * from programa ";
                  if ($resultado = $conexion->query($consulta)) { 
...
<label class="active" id="sesione">MONITORES</label>
            ...
            <div id="Divmonitores" class="input-field col s6" <?php echo $check; ?>>
                <input autocomplete="off" id="monitores" type="number" class="validate" data-length="8" maxlength="8">
                <label class="active" for="first_name2">($COP):</label>
            </div>
            ...
            <div id="Divdescripcion15" class="input-field col s12" <?php echo $check; ?>>
                  <textarea autocomplete="off" id="descripcion15" class="materialize-textarea"></textarea>
                  <label for="textarea1">descripcion</label>
            </div>

            
            <div id="DivObjeGene" class="input-field col s12">
                  <textarea autocomplete="off" id="ObjeGene" class="materialize-textarea"></textarea>
            ...
            if (isset($_POST['apro'])) {
              ...
              if ($cantidad==0) {
                ...
                for ($i=0; $i < $cantidad ; $i++) { 
                  $_SESSION['Programa"'.$i.'"']=$ArrayPro[$i];
                  $_SESSION['Programa"'.$i.'"'];
                }
              ...
              <script type="text/javascript">
                swal({title: "",
                    ...
                    function(){ window.location.href="investigacion.php"}
                    );
              </script>
              <?php
